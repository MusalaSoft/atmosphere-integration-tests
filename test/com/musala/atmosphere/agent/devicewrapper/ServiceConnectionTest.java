...
public class ServiceConnectionTest extends BaseIntegrationTest {
    ...
    //
    // private static final String PATH_TO_SERVICE_APK =
    // "C:\\prj\\ARDC\\Source\\AtmosphereIntegrationTests\\AtmophereService.apk";
    //
    // private static AgentIntegrationEnvironmentCreator agentEnvironment =
    // AtmosphereIntegrationTestsSuite.getAgentIntegrationEnvironmentCreator();
    //
    // private static IWrapDevice wrappedTestDevice;
    //
    // private static final String STOP_ATMOSPHERE_SERVICE =
    // "adb am broadcast -a com.musala.atmosphere.service.SERVICE_CONTROLL --es command stop";
    //
    // @BeforeClass
